...
<aside
    ...
    <?php echo e($attributes->class([
            'fi-sidebar fixed inset-y-0 start-0 z-30 flex flex-col h-screen content-start bg-white transition-all dark:bg-gray-900 lg:z-0 lg:bg-white lg:shadow-none lg:ring-0 lg:transition-none dark:lg:bg-white',
...
<?php /**PATH C:\laragon\www\clinic\vendor\filament\filament\resources\views/components/sidebar/index.blade.php ENDPATH**/ ?>